...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{ _asset('js/main.css') }}" integrity="sha384-n/D4CGg8rdH+l4B7ni0enlIYupZIc5AZTMD6vwyKToSvR2PbmloehIvnzdfdPbw/ sha384-IYBRoy5uhZ259GcUObJ+ZKQuqRm8pfdZlYFvPbtzT+zwP/1BOqqoe7ds2RqB0hlr" crossOrigin="anonymous">
  </head>
  <body>
    <main></main>
    ...
    <script src="{{ _asset('js/manifest.js') }}" integrity="sha384-/D3AGYPHOG62N83IIOYsJ2lYIInATz01gDy9/j27QKytBPdwyHBU4jWFIXGMoTot sha384-yCYDb1zpQsaLY4xtYLD8u/a8zApva1Q3H1YZ/oVVNoQZ7SQUqmHJV7LjF0mxc6vR" crossOrigin="anonymous" defer></script>
    <script src="{{ _asset('js/vendor.js') }}" integrity="sha384-cC8Qtc/wZ62CIg2Jmh/K78kdyv5L6aLAI2z/wl6AFK6a4DR0afOPW0s6LgUlMDd2 sha384-L6apBCqZG+lz25bcxlkIe9J9JZtNtHm61wZ2LfHL8bw+67X6Y3n22alSIZe5vWFl" crossOrigin="anonymous" defer></script>
    <script src="{{ _asset('js/main.js') }}" integrity="sha384-4bRWbS31subKvKc9iuJjkipUvI++gIbk98GKx6V4SYZ2K2Ts2hS/23WaNzWkWefu sha384-jBrAEcOSedO4PqHvyWOhSIfph0pjm6flFkeTD/OTy1zJiPS/mMeB2CtP/5RknoHR" crossOrigin="anonymous" defer></script>
  </body>
</html>
