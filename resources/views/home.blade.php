...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{ _asset('js/main.css') }}" integrity="sha384-o/YUd0VjAIcplBKCU/ohHPhADT/Kr0XmSd7UV+CQCDe+IMXuIalYO0WZaK3l1vF1" crossOrigin="anonymous">
  </head>
  <body>
    <main></main>
    ...
    <script src="{{ _asset('js/vendor.js') }}" integrity="sha384-HncTACYHnHPW1mTGIyaBPpp1UYkCfxxZuCqHflEG8Wv3/j5oxQFnhaQ4kpUYhybC" crossOrigin="anonymous" defer></script>
    <script src="{{ _asset('js/main.js') }}" crossOrigin="anonymous" defer></script>
  </body>
</html>
